 ...
 * @author kikuta
 */
public class MailAddressVerificationByJavaMail {

    public static void main(String[] args) {
        try {
            System.out.println("ドットではじまるアドレス：");
            InternetAddress ドットではじまるアドレス = new InternetAddress(".abcde@example.com", true);
        ...
        try {
            ...
            InternetAddress 連続したドットが含まれているアドレス = new InternetAddress("ab..cde@example.com", true);
        } catch (AddressException ex) {
            System.out.println(ex.getMessage());
            Logger.getLogger(MailAddressVerificationByJavaMail.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            InternetAddress アットマークの前がドット = new InternetAddress("abcde.@example.com", true);
        } catch (AddressException ex) {
            System.out.println(ex.getMessage());
            Logger.getLogger(MailAddressVerificationByJavaMail.class.getName()).log(Level.SEVERE, null, ex);
        }
